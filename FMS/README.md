...
To update the database use this command from the Web project folder (replace `FMS` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../FMS.Infrastructure/FMS.Infrastructure.csproj -s FMS.Web.csproj
```
